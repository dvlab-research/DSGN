...
cfg.hg_rpn_conv3d = False # replace rpn3d_conv
cfg.hg_firstconv = True
cfg.rpn3d_conv_kernel = 1
cfg.hg_rpn_conv = True # replace rpn3d_conv3
cfg.fix_centerness_bug = True

# network
cfg.backbone = 'reslike-det-small-fixfirst'
